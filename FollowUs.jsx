...
function FollowUs() {
    return (
        <div className="flex flex-row flex-wrap">
            <a href="https://www.instagram.com/butantem/" className="flex w-full lg:flex-1 bg-purple-600 hover:bg-pink-600 p-6 justify-between transition duration-300 ease-in-out">
                <p className="text-white text-md font-semibold">Siga-nos Instagram</p>
            ...
            <a href="https://www.facebook.com/butantem" className="flex w-full lg:flex-1 bg-blue-700 hover:bg-blue-900 p-6 justify-between transition duration-300 ease-in-out">
                <p className="text-white text-md font-semibold">Siga-nos no Facebook</p>
            ...
            <a href="https://twitter.com/butantem" className="flex w-full lg:flex-1 bg-blue-300 hover:bg-blue-500 p-6 justify-between transition duration-300 ease-in-out">
                <p className="text-white text-md font-semibold">Siga-nos no Twitter</p>

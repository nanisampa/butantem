                ...
                <div className="flex flex-wrap">
                    {
                        ...
                        ) : <div className="w-full flex m-3 p-4 bg-covid-200 rounded"><p className="text-center text-gray-800">Sem eventos progamados.</p></div>
                    }

                </div>
            </div>
            <div>
                <h2 className="text-2xl font-medium text-gray-800 self-start font-serif mb-2">Eventos anteriores</h2>
                <div className="flex flex-wrap">
                    {
